import { Box, List, Typography, Divider, Paper, Card, CardContent, Grid, Button } from '@mui/material'
        ...
        <>
            ...
            <Box sx={{ p: 3, maxWidth: 1200, margin: "auto" }}>
                ...
                <Button variant='contained'
                    onClick={() => cancelOrderReq()}>Cancel order</Button>
            </Box>
        </>
    )
}
